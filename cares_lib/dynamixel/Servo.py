...
class Servo(object):
    ...
    def move(self, target_position, wait=True, timeout=5):
        ...
        try:
            ...
            self.process_result(dxl_comm_result, dxl_error,
                                message=f"successfully told to move to {self.target_position}")
    ...
    def is_moving(self):
        try:
            ...
            logging.debug(
                f"Dynamixel#{self.motor_id} is at position {current_position} and moving to {self.target_position}")
